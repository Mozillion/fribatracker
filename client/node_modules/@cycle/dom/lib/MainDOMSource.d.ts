...
export declare class MainDOMSource implements DOMSource {
    ...
    private _name;
    constructor(_rootElement$: Stream<Element>, _runStreamAdapter: StreamAdapter, _namespace: Array<string>, _isolateModule: IsolateModule, _delegators: Map<string, EventDelegator>, _name: string);
    elements(): any;
