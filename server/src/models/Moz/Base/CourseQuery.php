 ...
 * @method     ChildCourseQuery orderByRating($order = Criteria::ASC) Order by the rating column
 * @method     ChildCourseQuery orderByUserId($order = Criteria::ASC) Order by the user_id column
 *
 * @method     ChildCourseQuery groupById() Group by the id column
 * @method     ChildCourseQuery groupByName() Group by the name column
 * @method     ChildCourseQuery groupByRating() Group by the rating column
 * @method     ChildCourseQuery groupByUserId() Group by the user_id column
 *
 ...
 *
 * @method     ChildCourseQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method     ChildCourseQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method     ChildCourseQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
 * @method     ChildCourseQuery joinWithUser($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the User relation
 *
 * @method     ChildCourseQuery leftJoinWithUser() Adds a LEFT JOIN clause and with to the query using the User relation
 * @method     ChildCourseQuery rightJoinWithUser() Adds a RIGHT JOIN clause and with to the query using the User relation
 * @method     ChildCourseQuery innerJoinWithUser() Adds a INNER JOIN clause and with to the query using the User relation
 *
 * @method     ChildCourseQuery leftJoinFairway($relationAlias = null) Adds a LEFT JOIN clause to the query using the Fairway relation
 * @method     ChildCourseQuery rightJoinFairway($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Fairway relation
 * @method     ChildCourseQuery innerJoinFairway($relationAlias = null) Adds a INNER JOIN clause to the query using the Fairway relation
 *
 * @method     ChildCourseQuery joinWithFairway($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Fairway relation
 *
 * @method     ChildCourseQuery leftJoinWithFairway() Adds a LEFT JOIN clause and with to the query using the Fairway relation
 * @method     ChildCourseQuery rightJoinWithFairway() Adds a RIGHT JOIN clause and with to the query using the Fairway relation
 * @method     ChildCourseQuery innerJoinWithFairway() Adds a INNER JOIN clause and with to the query using the Fairway relation
 *
 * @method     ChildCourseQuery leftJoinLayout($relationAlias = null) Adds a LEFT JOIN clause to the query using the Layout relation
 * @method     ChildCourseQuery rightJoinLayout($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Layout relation
 * @method     ChildCourseQuery innerJoinLayout($relationAlias = null) Adds a INNER JOIN clause to the query using the Layout relation
 *
 * @method     ChildCourseQuery joinWithLayout($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Layout relation
 *
 * @method     ChildCourseQuery leftJoinWithLayout() Adds a LEFT JOIN clause and with to the query using the Layout relation
 * @method     ChildCourseQuery rightJoinWithLayout() Adds a RIGHT JOIN clause and with to the query using the Layout relation
 * @method     ChildCourseQuery innerJoinWithLayout() Adds a INNER JOIN clause and with to the query using the Layout relation
 *
 * @method     \Moz\UserQuery|\Moz\FairwayQuery|\Moz\LayoutQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildCourse findOneByRating(string $rating) Return the first ChildCourse filtered by the rating column
 * @method     ChildCourse findOneByUserId(int $user_id) Return the first ChildCourse filtered by the user_id column *
 ...
 * @method     ChildCourse requireOneByRating(string $rating) Return the first ChildCourse filtered by the rating column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCourse requireOneByUserId(int $user_id) Return the first ChildCourse filtered by the user_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildCourse[]|ObjectCollection findByRating(string $rating) Return ChildCourse objects filtered by the rating column
 * @method     ChildCourse[]|ObjectCollection findByUserId(int $user_id) Return ChildCourse objects filtered by the user_id column
...
abstract class CourseQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Moz\Base\CourseQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Moz\\Course', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, rating, user_id FROM course WHERE id = :p0';
        try {
    ...
    public function filterByRating($rating = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CourseTableMap::COL_RATING, $rating, $comparison);
    }
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        if (is_array($userId)) {
            $useMinMax = false;
            if (isset($userId['min'])) {
                $this->addUsingAlias(CourseTableMap::COL_USER_ID, $userId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userId['max'])) {
                $this->addUsingAlias(CourseTableMap::COL_USER_ID, $userId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CourseTableMap::COL_USER_ID, $userId, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \Moz\User) {
            return $this
                ->addUsingAlias(CourseTableMap::COL_USER_ID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CourseTableMap::COL_USER_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param \Moz\Fairway|ObjectCollection $fairway the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildCourseQuery The current query, for fluid interface
     */
    public function filterByFairway($fairway, $comparison = null)
    {
        if ($fairway instanceof \Moz\Fairway) {
            return $this
                ->addUsingAlias(CourseTableMap::COL_ID, $fairway->getCourseId(), $comparison);
        } elseif ($fairway instanceof ObjectCollection) {
            return $this
                ->useFairwayQuery()
                ->filterByPrimaryKeys($fairway->getPrimaryKeys())
                ->endUse();
        } else {
    ...
    public function filterByLayout($layout, $comparison = null)
    {
        if ($layout instanceof \Moz\Layout) {
            return $this
                ->addUsingAlias(CourseTableMap::COL_ID, $layout->getCourseId(), $comparison);
