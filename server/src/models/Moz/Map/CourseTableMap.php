...
class CourseTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Moz.Map.CourseTableMap';
     ...
     */
    const OM_CLASS = '\\Moz\\Course';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Moz.Course';
     ...
     */
    const COL_RATING = 'course.rating';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'course.user_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Rating', 'UserId', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'rating', 'userId', ),
        self::TYPE_COLNAME       => array(CourseTableMap::COL_ID, CourseTableMap::COL_NAME, CourseTableMap::COL_RATING, CourseTableMap::COL_USER_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'rating', 'user_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Rating' => 2, 'UserId' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'rating' => 2, 'userId' => 3, ),
        self::TYPE_COLNAME       => array(CourseTableMap::COL_ID => 0, CourseTableMap::COL_NAME => 1, CourseTableMap::COL_RATING => 2, CourseTableMap::COL_USER_ID => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'rating' => 2, 'user_id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Moz\\Course');
        $this->setPackage('Moz');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 100, null);
        $this->addColumn('rating', 'Rating', 'VARCHAR', false, 4, null);
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Fairway', '\\Moz\\Fairway', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':course_id',
    1 => ':id',
  ),
), null, null, 'Fairways', false);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CourseTableMap::COL_RATING);
            $criteria->addSelectColumn(CourseTableMap::COL_USER_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Moz\Course) { // it's a model object
