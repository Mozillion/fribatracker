...
class PlayerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Moz.Map.PlayerTableMap';
     ...
     */
    const OM_CLASS = '\\Moz\\Player';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Moz.Player';
     ...
     */
    const COL_FIRST_NAME = 'player.first_name';

    /**
     * the column name for the last_name field
     */
    const COL_LAST_NAME = 'player.last_name';

    /**
     * the column name for the time_created field
     */
    const COL_TIME_CREATED = 'player.time_created';

    /**
     * the column name for the created_by_user_id field
     */
    const COL_CREATED_BY_USER_ID = 'player.created_by_user_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'FirstName', 'LastName', 'TimeCreated', 'CreatedByUserId', ),
        self::TYPE_CAMELNAME     => array('id', 'firstName', 'lastName', 'timeCreated', 'createdByUserId', ),
        self::TYPE_COLNAME       => array(PlayerTableMap::COL_ID, PlayerTableMap::COL_FIRST_NAME, PlayerTableMap::COL_LAST_NAME, PlayerTableMap::COL_TIME_CREATED, PlayerTableMap::COL_CREATED_BY_USER_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'first_name', 'last_name', 'time_created', 'created_by_user_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'FirstName' => 1, 'LastName' => 2, 'TimeCreated' => 3, 'CreatedByUserId' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'firstName' => 1, 'lastName' => 2, 'timeCreated' => 3, 'createdByUserId' => 4, ),
        self::TYPE_COLNAME       => array(PlayerTableMap::COL_ID => 0, PlayerTableMap::COL_FIRST_NAME => 1, PlayerTableMap::COL_LAST_NAME => 2, PlayerTableMap::COL_TIME_CREATED => 3, PlayerTableMap::COL_CREATED_BY_USER_ID => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'first_name' => 1, 'last_name' => 2, 'time_created' => 3, 'created_by_user_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        $this->addRelation('UserRelatedByCreatedByUserId', '\\Moz\\User', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('UserRelatedByPlayerId', '\\Moz\\User', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':player_id',
    1 => ':id',
  ),
), null, null, 'UsersRelatedByPlayerId', false);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PlayerTableMap::COL_FIRST_NAME);
            $criteria->addSelectColumn(PlayerTableMap::COL_LAST_NAME);
            $criteria->addSelectColumn(PlayerTableMap::COL_TIME_CREATED);
            $criteria->addSelectColumn(PlayerTableMap::COL_CREATED_BY_USER_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Moz\Player) { // it's a model object
